...
CREATE TABLE Utente(Id INTEGER,Nome VARCHAR(50),Cognome VARCHAR(50),Email VARCHAR(50),IAbb DATE,FAbb DATE,day_corrente TINYINT,IdIstruttore INTEGER NOT NULL,PRIMARY KEY(Id),FOREIGN KEY (IdIstruttore) REFERENCES Istruttore(Id));
